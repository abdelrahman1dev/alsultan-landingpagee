...
const testimonialsStudents: Testimonial[] = [
  { quote: "أستاذ السلطان يجعل دروس التاريخ ممتعة ومثيرة! نجحت في الامتحان بدرجات عالية بفضله.", author: "سارة أحمد", role: "طالبة - أولى ثانوي" },
  { quote: "شرح رائع ومبسط يغطي كل التفاصيل. أصبحت أحب مادة التاريخ حقاً!", author: "محمد علي", role: "طالب - ثانية ثانوي" },
  { quote: "دروس تفاعلية تجعلك تشعر وكأنك تعيش الأحداث التاريخية. أفضل أستاذ!", author: "فاطمة سالم", role: "طالبة - ثالثة ثانوي" },
  { quote: "يساعدنا على فهم العلاقات بين الأحداث بطريقة منطقية. شكراً أستاذ السلطان!", author: "عمر خالد", role: "طالب - أولى ثانوي" },
  { quote: "تمارين واختبارات ممتازة ساعدتني على التفوق في التقييمات الدورية.", author: "نورا حسن", role: "طالبة - ثانية ثانوي" },
  { quote: "عاطفة حقيقية تجاه التاريخ تنتقل إلينا. منصة رائعة ومنظمة.", author: "أحمد محمود", role: "طالب - ثالثة ثانوي" },
];
...
function MarqueeRow({
  ...
  return (
    <div className="relative flex overflow-hidden py-4" style={{ direction: 'ltr' }}>
      {/* Edge Fades */}
    ...
    <section className="w-full py-20 bg-[#0d0d0d] overflow-hidden">
      <div className="max-w-400 mx-auto">
        <div className="flex flex-col gap-8 md:gap-12">
           ...
           <MarqueeRow testimonials={testimonialsStudents} reverse duration={45} />
        </div>
      </div>
    </section>
  );
