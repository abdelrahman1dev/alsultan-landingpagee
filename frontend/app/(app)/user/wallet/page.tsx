        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <CardLayout classname="col-span-1 lg:col-span-3  backdrop-blur-sm border-[#3b3b34]/50">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              ...
              <Link
                href="/user/history"
                className="flex items-center gap-2 text-[#e6d3a3]/70 hover:text-[#e6d3a3] transition"
              >
                <ChevronLeft size={20} />
                سجل العمليات
              </Link>
              ...
              {topUpMethods.map((method) => (
                ...
                >
                  <div className="p-4 bg-[#3b3b34]/50 rounded-2xl mb-4 group-hover:bg-[#e6d3a3]/10 transition">
                    <method.icon
                      size={32}
                      className="text-[#e6d3a3] group-hover:scale-110 transition"
                    />
                  </div>
                  <h3 className="font-semibold text-[#e6d3a3] mb-1">
                    {method.title}
                  </h3>
                  <p className="text-xs text-[#e6d3a3]/60">
                    {method.description}
                  </p>
                  <ArrowRight
                    size={20}
                    className="mt-auto text-[#e6d3a3]/70 group-hover:translate-x-1 transition self-end"
                  />
                </Link>
              ))}
            </div>
          ...
          <CardLayout classname="col-span-1 lg:col-span-3">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-semibold text-[#e6d3a3]">
                آخر العمليات
              </h3>
              <Link
                href="#"
                className="text-[#e6d3a3]/70 hover:text-[#e6d3a3] flex items-center gap-1 text-sm transition"
              >
            ...
            <div className="space-y-3">
              {[
                ...
                <div
                  key={index}
                  className="flex items-center justify-between p-4 bg-[#1a1a1a]/50 hover:bg-[#222] rounded-xl transition cursor-pointer group"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-[#e6d3a3]">
                        {transaction.type}
                      </p>
                      <p className="text-sm text-[#e6d3a3]/60">
                        {transaction.date}
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-xl text-[#e6d3a3]">
                      {transaction.amount}
                    </p>
