...
// the user schema simply cares about required/optional fields
...
export const signupSchema = z.object({
    ...
    studentPhone: z.string().trim().regex(EGYPT_MOBILE_REGEX, "Invalid egyptian mobile phone number."),
    parentPhone: z.string().trim().regex(EGYPT_MOBILE_REGEX, "Invalid egyptian mobile phone number."),
    specialization: z.string().optional(),
    ...
    confirmPassword: z.string().min(MIN_PASSWORD_LENGTH, "Password is too short.")
})
